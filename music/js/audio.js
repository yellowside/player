;(function($){
	...
	window[fnName] = function(setConfig){
		...
		_this.upMenu = function(){
			...
			for(var i in song){
				inline.append("<li><a href='https://www.29dns.cn/' target='_blank'>实用工具</a></li><li><a href='https://fuli.fanbing.cc/' target='_blank'>福利天天领</a></li><li><a href='https://bingdou.vip/' target='_blank'>视频云播</a></li><li><a href='https://www.3600.win/' target='_blank'>实用导航</a></li>");
			}
